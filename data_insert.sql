...
('Amekaji', 'Spring', NULL, 'Olive', 'Brown'),
('Amekaji', 'Spring', NULL, 'Navy', 'Denim'),
...
('Amekaji', 'Summer', NULL, 'White', 'Light Blue'),
('Amekaji', 'Summer', NULL, 'Beige', 'Olive'),
('Amekaji', 'Summer', NULL, 'Olive', 'Denim'),
('Amekaji', 'Summer', NULL, 'Navy', 'Light Blue'),
...
('Street', 'Spring', NULL, 'Black', 'White'),
('Street', 'Spring', NULL, 'Gray', 'Navy'),
('Street', 'Spring', 'Black', 'Burgundy', 'Blue'),
('Street', 'Spring', 'Black', 'Gray', 'Black'),
('Street', 'Spring', NULL, 'White', 'Light Blue'),
('Street', 'Spring', 'Navy', 'Olive', 'Khaki'),
('Street', 'Spring', 'Gray', 'Blue', 'Beige'),
('Street', 'Spring', 'Black', 'White', 'Navy'),
('Street', 'Summer', NULL, 'Black', 'Gray'),
('Street', 'Summer', NULL, 'Gray', 'Light Blue'),
('Street', 'Summer', NULL, 'Khaki', 'Denim'),
('Street', 'Summer', NULL, 'Blue', 'Gray'),
...
('Street', 'Autumn', NULL, 'Black', 'Denim'),
...
('Casual', 'Summer', NULL, 'Gray', 'Denim'),
('Casual', 'Summer', NULL, 'Navy', 'Light Blue'),
('Casual', 'Summer', NULL, 'Beige', 'Olive'),
...
('Minimal', 'Spring', NULL, 'Black', 'Light Blue'),
...
('Minimal', 'Summer', NULL, 'Black', 'Gray'),
('Minimal', 'Summer', NULL, 'Navy', 'Light Blue'),
('Minimal', 'Summer', NULL, 'Beige', 'Olive'),
